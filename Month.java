...
public class Month {
	...
	public Month(int _monthNumber) throws MonthOutOfRange {
		if(_monthNumber >= 1 && _monthNumber <= 12){
			this._monthNumber = _monthNumber;
		}
		else{
			throw new MonthOutOfRange(_monthNumber);
		}
	}

	public Month(String month) throws MonthNameInvalid {
		switch (month) {
		case "January":
			this._monthNumber = 1;
			break;
		...
		case "December":
			...
			break;
		default:
			throw new MonthNameInvalid(month);
		}
	}
	//instance method
